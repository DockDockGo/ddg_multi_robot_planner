...
def read_planed_paths(plan_file_path, map_data):
    try:
        ...
        print(f"File '{plan_file_path}' not found.")
...
map_file_path = "/home/vineet/mfi_maps/Sept1/real_map-downsampled.map"
plan_file_path = "/home/vineet/test/CBSH2-RTC/paths.txt"
